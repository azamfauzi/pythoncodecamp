...
for (table_name) in cursor:
    ...
    print('            <input class="form-control" placeholder="' + table_name[0] + '" type="text" id="' + table_name[0] + '" name="' + table_name[0] + '" value="<?php if(isset($' + person + '->' + table_name[0] + ')){ echo $' + person + '->' + table_name[0] + ';}?>">')
    print('         </div>')
    print('</div>')    
    cursor.close
print("")
