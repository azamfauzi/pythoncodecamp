...
for (table_name) in cursor:
    ...
    print('            <textarea cols="50" rows="5" placeholder="' + table_name[0] + '" type="text" name="' + table_name[0] + '"></textarea>')
    print('         </div>')
    print('</div>')
...
for (table_name) in cursor:
    ...
    print('     <label class="col-md-2 control-label">' + table_name[0] +  '</label>')
    print('         <div class="col-md-5">')
    print('            <textarea class="form-control" placeholder="' + table_name[0] + '" name="' + table_name[0] + '"><?php if(isset($' + person + ')){ echo $' + person + "->" + table_name[0] + ';} ?>"</textarea>')
    print('         </div>')
    print('</div>')    
    cursor.close
print("")
